...
create index members_couple_id_idx on members (couple_id);
create index countdowns_couple_id_idx on countdowns (couple_id);
create index bucket_items_couple_id_idx on bucket_items (couple_id);
create index pings_couple_id_created_idx on pings (couple_id, created_at desc);
